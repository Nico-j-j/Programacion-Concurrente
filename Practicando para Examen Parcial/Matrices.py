...
def par_mult(A, B): # f() que prepara el reparto de trabajo para l a mult. en paralelo
...
if __name__ == '__main__':
    A = [[random.randint(0,215) for i in range(6)] for j in range(2217495)] # Genero A[21535220][6]con num. aleatorios del 0 al 215, ver excel 
